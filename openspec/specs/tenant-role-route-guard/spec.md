# Spec: Tenant Role Route Guard

## Purpose

Defines server-side role enforcement for tenant route groups, ensuring authenticated users can only access pages matching their tenant role.
