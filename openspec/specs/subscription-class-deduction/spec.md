# Capability: subscription-class-deduction

## Purpose
Manages automatic class balance deduction when an athlete books a plan-restricted training session, and restores that class balance on cancellation. Uses SECURITY DEFINER RPCs to ensure atomic, race-condition-safe operations.
