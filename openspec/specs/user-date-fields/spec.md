# Spec: User Date Fields

## Purpose

Defines database schema and view changes to expose `fecha_nacimiento` and `fecha_exp_identificacion` user date fields across reporting and team management views.
