# Capability: plan-duplication

## Purpose
Defines the plan duplication flow that allows tenant administrators to create a copy of an existing membership plan (including its subtypes) via a pre-filled creation modal.
