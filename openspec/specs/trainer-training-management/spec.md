# Spec: Trainer Training Management

## Purpose

Defines the permissions and capabilities for users with the `entrenador` role to create, edit, delete, and manage training sessions and booking restrictions within their tenant.
