...
- [x] 6.1 Write the commit message summarizing the fix (root cause: UTC vs. Bogotá day-boundary mismatch in range queries) and a pull request description referencing US-0075, listing the affected files and the manual verification performed
