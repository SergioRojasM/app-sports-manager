...
- [x] 12.1 Write a commit message summarizing the section-based form builder refactor (migration, renamed types/service/hooks, new editor page and components, icon-based list actions, breadcrumb fix)
- [x] 12.2 Write a pull request description covering: why (US-0085), what changed (including the **BREAKING** schema/type/service renames), database migration notes (local-only, not yet pushed to remote), and a manual test plan checklist derived from section 10
