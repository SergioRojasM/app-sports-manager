...
- [x] 10.4 Manual test: athlete with zero reservations sees the new cross-tenant empty state — **not exercised**: no zero-reservation seeded athlete was tested; empty-state copy change was verified by code review only
