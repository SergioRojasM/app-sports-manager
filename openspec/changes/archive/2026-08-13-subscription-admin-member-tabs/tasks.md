...
- [x] 8.2 Write a commit message summarizing the membership tab split and Tipo column
- [x] 8.3 Write a pull request description referencing US-0098, summarizing the change, and including a manual test plan checklist
