...
- [x] 7.2 Write a pull request description covering: the two root causes, the fix for each (categorias hydration + `skipNextCategoriasResetRef` reuse; restrictions section auto-expand), files changed, and the manual test steps from section 5.
