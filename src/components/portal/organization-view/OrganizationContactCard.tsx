import type { OrganizationContactPayload } from '@/types/portal/organization-view.types';
import type { OrganizationSocialPayload } from '@/types/portal/organization-view.types';

type OrganizationContactCardProps = {
...
export function OrganizationContactCard({ contact, social }: OrganizationContactCardProps) {
