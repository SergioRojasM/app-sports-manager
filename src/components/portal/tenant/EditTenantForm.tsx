...
export function EditTenantForm({ values, errors, isSubmitting, onChange, logoUpload }: EditTenantFormProps) {
  ...
  const isDisabled = isSubmitting || (logoUpload?.uploading ?? false);
