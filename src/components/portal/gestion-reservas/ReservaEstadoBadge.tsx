...
export function ReservaEstadoBadge({ estado }: ReservaEstadoBadgeProps) {
  const style = BADGE_STYLES[estado as ReservaEstado] ?? BADGE_STYLES.confirmada;
