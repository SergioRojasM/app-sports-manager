...
export function useOrgLogoUpload(): UseOrgLogoUploadResult {
  ...
  const upload = useCallback(
    async (tenantId: string): Promise<string | null> => {
      ...
      try {
        ...
        const result = await storageService.uploadOrgLogo(supabase, tenantId, selectedFile);
