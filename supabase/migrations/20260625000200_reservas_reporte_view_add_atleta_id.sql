-- =============================================
-- Migration: Recreate reservas_reporte_view with atleta_id column
-- US-0074: Athlete personal reservations view needs atleta_id for direct ID-based filtering
-- =============================================
