-- View: reservas_reporte_view
-- Flat view joining reservas with athlete, training, discipline, scenario,
-- attendance, validator, category and level data for CSV export.
